    ...
    if current_time - last_time_sent > interval:
        if results1.pose_landmarks:
            ...
            for pose_id, pose_lm in enumerate(results1.pose_landmarks.landmark):
                ...
                elif pose_id>22 and pose_id<33:
                    last_good_data.update({23:(226, 222.4, 95.1, 0.99), 24:(204.0, 210.9, 97.8, 0.99), 25:(224.7, 260.2, 98.6, 0.98), 26:(206.4, 254.3, 104.0, 0.98), 27:(231.0, 309.6, 148.06, 0.97), 28:(220.3, 307.3, 147.0, 0.98), 31:(220.5, 324.1, 120.4, 0.97), 32:(205.2, 320.9, 117.7, 0.97)})
                else:
